...
protected:
	...
	T *list; //Lista implementada como Array
	unsigned int cantElem; //Cantidad de elementos del array
	unsigned int max; //Cantidad maxima de elementos del array

	//Funciones Auxiliares

	//PRE: La lista se encuentra llena
	//POS: Modifica el array para tener FACTOR_VEC elementos más, no modifica los datos
	void Redimensionar();

	//PRE: La lista tiene un lugar libre al final, Recibe la primera posicion a mover
	//POS: Modifica la lista para que todos los elementos se muevan un lugar a la derecha
	void Shift_Right(int pos);

	//PRE: Recibe la primera posicion a mover
	//POS: Modifica la lista para que todos los elementos se muevan un lugar a la izquierda
